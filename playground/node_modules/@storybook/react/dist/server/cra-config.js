...
function applyCRAWebpackConfig(baseConfig, configDir) {
  ...
  return _objectSpread({}, baseConfig, {
    ...
    resolve: _objectSpread({}, baseConfig.resolve, {
      ...
      modules: Array.from(new Set([...baseConfig.resolve.modules, ...(craWebpackConfig.resolve.modules || [])])),
      alias: _objectSpread({}, baseConfig.resolve.alias, {}, craWebpackConfig.resolve.alias)
    }),
    resolveLoader: {
